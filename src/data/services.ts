...
export const services: Service[] = [
  {
    ...
    shortDescription:
      "Framing, pergolas, fences, gates, trim, doors, sheds, and other small structures.",
    primary: true,
    examples: [
  ...
  },
  {
    ...
    name: "Electrical",
    shortDescription:
      "Lighting, outlets, switches, and small electrical projects around the home.",
    examples: [
  ...
  },
  {
    ...
    shortDescription:
      "Assembly and installation for home and office furniture, shelves, and wall décor.",
    examples: [
  ...
  },
  {
    ...
    shortDescription:
      "Small plumbing projects like faucets, sinks, disposals, toilets, and shower heads.",
    examples: [
  ...
  },
  {
    ...
    shortDescription:
      "Tackle a list of small projects and fixes around the house in a single visit.",
    examples: [
  ...
  },
  {
    ...
    name: "TV Mounting",
    shortDescription:
      "Safe, clean wall mounting for flat-screen TVs and media setups with hidden cabling when possible.",
    examples: [
