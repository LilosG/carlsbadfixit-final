...
export const serviceContent: Record<string, ServicePageContent> = {
    ...
    faq: [
      {
        ...
        answer:
          "Yes. Replacing damaged fence boards, tightening hardware, and tuning up wood gates are all good fits for a handyman visit, as long as we are not rebuilding long runs of fence from scratch.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "You are welcome to purchase specific trim, lumber, or hardware if you have something particular in mind. Otherwise, we can recommend standard options, pick them up locally, and include them on your final invoice.",
      },
    ],
  },
    ...
    faq: [
      {
        ...
        answer:
          "Yes, as long as there is an existing, properly supported electrical box and the new fixture is a safe match for the location. Very heavy fixtures or fans on tall ceilings may require a different type of contractor or lift equipment.",
      },
      {
        question: "Do you work on electrical panels or run new circuits?",
        answer:
          "No. Main service panels, subpanels, new circuits, and service upgrades should always be handled by a licensed electrical contractor. Our focus is on small, accessible projects within existing circuits.",
      },
      {
        question: "Do I need to provide the fixtures and devices?",
        answer:
          "Most homeowners prefer to choose their own fixtures and devices so they match the rest of the home. If you would like suggestions, we can point you toward common options that work well in small projects.",
      },
    ],
  },
  ...
  "furniture-assembly-installation": {
    ...
    typicalProjectsHeading:
      "Typical furniture assembly and installation projects",
    ...
    pricingHeading:
      "How pricing works for furniture assembly and installations",
    pricingParagraphs: [
    ...
    faq: [
      {
        ...
        answer:
          "It depends on the size and complexity of each item. A typical visit might include several small pieces or one larger piece plus a few wall-mounted items. If you share your list ahead of time, we can estimate what fits comfortably into a single visit.",
      },
      {
        question: "Can you secure tall furniture to the wall?",
        answer:
          "Yes. Securing tall dressers, bookcases, and media cabinets with manufacturer-supplied anti-tip brackets is a great fit for a handyman visit, especially in homes with kids or pets.",
      },
      {
        question: "Do you bring anchors and basic hardware?",
        answer:
          "Yes. We carry common anchors and fasteners for drywall and wood framing. If your project needs specialty hardware or brackets, we may ask you to purchase those ahead of time or add a quick materials run to your visit.",
      },
    ],
  },
  ...
  "plumbing-fixtures-repairs": {
    ...
    typicalProjectsHeading:
      "Typical plumbing fixture and small repair projects",
    ...
    faq: [
      {
        ...
        answer:
          "No. Hidden leaks in supply or drain lines inside walls or ceilings should be handled by a licensed plumber. We can often help with small, visible leaks at traps, flexible connections, or fixtures.",
      },
      {
        question:
          "Do you install new faucets and disposers I’ve already purchased?",
        answer:
          "Yes. Many homeowners prefer to choose fixtures that match their style. As long as they are compatible with your existing plumbing and electrical connections, installing them is a good fit for a handyman visit.",
      },
      {
        question: "Will you shut off water to the whole house?",
        answer:
          "For some projects, yes. If individual shutoff valves are stuck or missing, we may need to shut off water at the main for a short time while repairs are made.",
      },
    ],
  },
    ...
    faq: [
      {
        ...
        answer:
          "You can include as many items as you like. We will help you prioritize the list and estimate what can be completed within a standard visit, then work from most important to least important.",
      },
      {
        question: "Can you add new projects on the day of the visit?",
        answer:
          "If there is time left in the visit and we have the right tools and materials, we are happy to add small, related items. Larger surprises may need a follow-up visit so we can plan properly.",
      },
      {
        question: "What if a task turns out to be bigger than expected?",
        answer:
          "If we uncover a larger issue, we will explain what we found and recommend next steps. Sometimes that means a future visit with more time set aside, and sometimes it means bringing in a specialist.",
      },
    ],
  },
    ...
    faq: [
      {
        ...
        answer:
          "We can usually get close enough that repairs are not obvious once painted, especially in standard textures. Very unique or hand-troweled finishes may still show a subtle transition.",
      },
      {
        question: "Do you paint after drywall repairs?",
        answer:
          "We can often handle basic priming and small touch-ups if we have the correct paint on hand. Larger repainting projects are usually better handled by a dedicated painting contractor.",
      },
      {
        question: "What if there was a leak involved?",
        answer:
          "The source of the leak should be repaired and the area fully dried before we begin drywall work. If we suspect there is still moisture or damage, we will recommend next steps before closing things up.",
      },
    ],
  },
    ...
    faq: [
      {
        ...
        answer:
          "Most homeowners purchase their own mounts so they can match TV size and desired features. We are happy to help you choose an appropriate mount style before your visit.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "We can help with basic connections to existing devices and make sure everything powers on. More advanced configuration, such as streaming account setup or complex audio systems, is usually outside the scope of a standard visit.",
      },
    ],
  },
};
